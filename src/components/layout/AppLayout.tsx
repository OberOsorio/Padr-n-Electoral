    ...
    <div className="h-[100dvh] w-full bg-slate-50 dark:bg-[#0F172A] text-slate-900 dark:text-slate-100 flex overflow-hidden transition-colors duration-200 relative">
      ...
      <div className="flex-1 h-full overflow-y-auto bg-slate-50 dark:bg-[#0F172A] transition-colors duration-200 flex flex-col">
        ...
        {isSuperAdminInspection && (
          <div className="w-full shrink-0 sticky top-0 z-40 bg-gradient-to-r from-purple-950/95 via-slate-900/95 to-purple-950/95 text-purple-200 border-b border-purple-500/40 px-4 py-2.5 flex flex-wrap items-center justify-between gap-3 text-xs backdrop-blur-md shadow-lg shadow-purple-950/20">
            <div className="flex items-center gap-2.5">
              <span className="px-2.5 py-0.5 rounded-full bg-purple-500/20 text-purple-300 font-mono font-bold tracking-wider uppercase border border-purple-500/40 text-[10px] flex items-center gap-1.5 shadow-[0_0_10px_rgba(168,85,247,0.2)]">
            ...
            <div className="flex items-center gap-2">
              {onOpenGateway && (
                <button
                  ...
                  className="px-3 py-1 rounded-lg bg-slate-800 hover:bg-slate-700 text-slate-200 border border-slate-700 hover:border-slate-600 transition-colors font-medium text-[11px] cursor-pointer"
                >
                  Cambiar Entorno
                </button>
              )}
              {onBackToMasterPlatform && (
                <button
                  ...
                  className="px-3.5 py-1 rounded-lg bg-purple-600 hover:bg-purple-500 text-white font-semibold shadow-xs transition-colors flex items-center gap-1.5 text-[11px] cursor-pointer"
                >
                  <ShieldCheck className="w-3.5 h-3.5" />
                  Volver al Master Platform
                </button>
              )}
            </div>
          </div>
